<div class="box-body">
  <input type="hidden" name="typeRedirect" value="{{isset($typeRedirect) ? $typeRedirect : ''}}">
  
  <div class="form-group">
    <label class="col-sm-2 control-label">@lang("messages.Proposal")<span class="red"> *</span> </label>
    <select class="form-control custom-select" name="proposal__c" required>
  ...
  <div class="form-group">
    ...
    <select class="form-control custom-select" name="budget__c" required>
      <option value=""> -- @lang("messages.None") --</option>
